...
if (!require(gClinBiomarker)) { 
  devtools::install_github("RPackages/gClinBiomarker",  host="https://github.roche.com/api/v3")
...
https://github.roche.com/Rpackages/gClinBiomarker/blob/master/inst/doc/example-use-cases.pdf

pdf version of this document can be found at:

https://github.roche.com/Rpackages/gClinBiomarker/blob/master/inst/doc/package-overview.pdf
