...
knit: (function(inputFile, encoding) { 
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path(dirname(inputFile), '/../inst/doc/gClinbiomarker_example_use_case.pdf')) })
output: 
  pdf_document:
    toc: true
...
```{r}
StatSummary(outcome.var = input$OS, treatment.var = input$Arm, 
...
### Create summary statistics
```{r}
StatSummary(outcome.var = input$OS.event, treatment.var = input$Arm, 
            placebo.code = "CTRL", active.code = "TRT", 
            outcome.class = "binary")
```
...
### Create summary statistics
```{r}
StatSummary(outcome.var = input[, c("OS", "OS.event")], 
