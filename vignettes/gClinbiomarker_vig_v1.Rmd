---
title: "gClinBiomarker Vignette"
author: "Ning Leng, Alexey Pronin, Christina Rabe, Doug Kelkhoff, Kwame Okrah"
date: '`r Sys.Date()`'
knit: (function(inputFile, encoding) { 
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path(dirname(inputFile), '/../inst/doc/gClinbiomarker_vig_v1.pdf')) })
output: 
  pdf_document:
    toc: true
    toc_depth: 4
...
https://github.roche.com/lengn/gClinbiomarker_documents/blob/master/gClinbiomarker_example_use_case.pdf
